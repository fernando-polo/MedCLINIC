...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('storage/css2/recuperacion1.css') }}">
    <meta name='viewport' content='width=device-width, initial-scale=1'>
    <script src='https://kit.fontawesome.com/a076d05399.js' crossorigin='anonymous'></script>
    <script src="https://maps.googleapis.com/maps/api/js?key=YOUR_API_KEY" async defer></script>
    <script src="{{ asset('storage/js/botones-entradas.js') }}" defer></script>
...
<body>
    ...
    <section>
        <div class="container2">
            <div class="iniciosesion">
                ...
                <div class="metodo">
                    <p>Escoge el método para recuperar tu contraseña</p>
                </div>
                <div class="botones">
                    <div>
                        <button class="telefono" onclick="redirigirNumero()">Número telefónico</button>
                    </div>
                    <div>
                        <button class="correo" onclick="redirigirCorreo()">Correo electrónico</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        function redirigirNumero() {
            window.location.href = '{{ route('recnumero') }}';
        }
        
        function redirigirCorreo() {
            window.location.href = '{{ route('reccorreo') }}';
        }
    </script>
</body>
</html>
