...
@section('content')
    ...
    <section class="studies">
        <h3><span class="spanzul">Prevención, Detección y Tratamiento Oportuno.</span></h3><h2>Nuestros <span>estudios</span></h2>
...
@section('extra-content')
    <section class="medicos">
        ...
        <div class="medicos-cards">
            ...
            <div class="medico-card2">
                <img src="{{ asset('img/medicoimg.png') }}" alt="Médico 1">
                <div class="medico-info">
                    <h3>Dr. Myrna Maldonado Badillo</h3>
                    <p>Especialidad</p>
                    <p>No. de Cédula</p>
    ...
    <section class="testimonios">
        ...
        <div class="testimonios-cards">
            <div class="testimonio-card">
                <img src="{{ asset('img/testimonioimg.png') }}" alt="Usuario 1">
    ...
    <section class="location">
        ...
        <div class="location-line"></div>
        <div class="img"><img src="{{ asset('img/ubica.png') }}" alt="ubicación" width="1100px" height="450px"></div>
    </section>
