...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('storage/css2/restablecerpass.css') }}">
...
<style>
    ...
    <section>
        <div class="container2">
            ...
            <form id="resetForm" action="{{ route('validate-password') }}" method="POST">
    @csrf
    ...
    <div class="form-group">
        <br>
        <input type="password" id="confirm_password" name="confirm_password" placeholder="Nueva contraseña nuevamente" required>
    </div>
    <div class="form-actions">
        <button id="login2Btn" type="submit" class="register">Confirmar contraseña</button>
    </div>
</form>
